		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers",
									"targetURL": "#comk3nstudioc03fiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comk3nstudioc03fiori-display": {
								"semanticObject": "comk3nstudioc03fiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.k3nstudio.c03fiori",
									"url": sap.ui.require.toUrl("com/k3nstudio/c03fiori")
								}
							}
						}
					}
